...
from app.utils import csv_to_dict, dict_to_transactions
...
async def create_transactions(
    session: SessionDep, current_user: CurrentUser, transaction_in: Transaction
) -> TransactionPublic:
...
def get_transactions(
    session: SessionDep, current_user: CurrentUser, start: int = 0, limit: int = 25
...
@router.post("/file")
async def insert_transactions_from_file(
